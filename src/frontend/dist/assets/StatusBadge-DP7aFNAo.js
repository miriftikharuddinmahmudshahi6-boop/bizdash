import { c as createLucideIcon, j as jsxRuntimeExports, m as Slot$2, a as cn, n as cva, r as reactExports, p as useControllableState, q as useId, P as Presence, s as Primitive, e as composeEventHandlers, t as Portal$2, u as useComposedRefs, v as hideOthers, w as createContext2, h as createContextScope, R as ReactRemoveScroll, x as useFocusGuards, F as FocusScope, y as DismissableLayer, z as createSlot, E as Primitive$1, G as useDirection, H as Root2$1, I as Anchor, J as useLayoutEffect2, K as reactDomExports, L as createPopperScope, M as createCollection, N as useCallbackRef, O as Content$1, Q as Arrow, V as ChevronDown, o, W as vt, S as Skeleton } from "./index-C44CPS2R.js";
import { f as UserStatus, T as TransactionStatus } from "./useBackend-CL3GtYM4.js";
/**
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { className: "bg-muted/30 hover:bg-muted/30 border-border/60", children: columns.map((col) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          TableHead,
          {
            className: cn(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: loading ? Array.from({ length: 5 }).map((_, i) => (
          // biome-ignore lint/suspicious/noArrayIndexKey: skeleton rows have no meaningful key
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { className: "border-border/40", children: columns.map((col) => /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-full" }) }, col.key)) }, `skeleton-${i}`)
        )) : data.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          TableCell,
          {
...
function StatusBadge({ status, className }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Badge,
    {
      ...
      style: config.muted ? void 0 : config.style,
